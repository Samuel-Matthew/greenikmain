            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-gray-400 mb-6">Leading the clean energy revolution with innovative solar, wind, and
                        sustainable power solutions for homes and businesses worldwide.</p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-gray-400 hover:text-primary transition-colors">Residential Solar</a>
                        </li>
                        <li><a href="#" class="text-gray-400 hover:text-primary transition-colors">Commercial
                                Systems</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-primary transition-colors">Energy Consulting</a>
                        </li>
                        <li><a href="#" class="text-gray-400 hover:text-primary transition-colors">Maintenance
                                Services</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-primary transition-colors">Energy Audits</a>
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-gray-400 hover:text-primary transition-colors">Installation
                                Guide</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-primary transition-colors">Warranty
                                Information</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-primary transition-colors">News &amp;
                                Updates</a></li>
