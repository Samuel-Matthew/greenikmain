                                                                    ...
                                                                    <div class="grid grid-cols-1 gap-y-4 gap-x-4 sm:grid-cols-2">
                                                                        <div class="sm:col-span-1">
                                                                            ...
                                                                            <input type="text" name="first_name" required
                                                                                class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 transition">
                                                                            @error('first_name')
...
<input type="number" name="amout" value="{{ intval($total * 100) }}" hidden>
                                                        ...
                                                        <section class="mt-10 lg:mt-0 lg:col-span-5">
                                                            <div class="bg-gray-900 border border-gray-700 rounded-xl p-6 sticky top-24">
