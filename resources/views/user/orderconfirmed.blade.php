...
$total = $order->total;
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="border-t border-gray-700 pt-4 flex justify-between items-center">
                            ...
                            <p class="text-xl font-bold text-green-500">₦{{ number_format($total, 2) }}</p>
                        </div>
                    </div>
                    <div class="mt-8 space-y-3">
                        <button onclick="window.print()"
                            class="w-full bg-[#309983]/10 hover:bg-white/10 text-white font-medium py-3 rounded-lg transition flex items-center justify-center gap-2">
