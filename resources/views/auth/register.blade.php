...
<body class="animated-bg min-h-screen">
            ...
            <form method="post" action="{{ route('register.store') }}" id="signUpForm" class="space-y-3">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div>
                        ...
                        <div class="text-red-500 text-xs mt-1 min-h-4" id="firstNameError"></div>
                    </div>
                    <div>
                        <div class="floating-label">
                        ...
                        <div class="text-red-500 text-xs mt-1 min-h-4" id="lastNameError"></div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="text-red-500 text-xs mt-1 min-h-4" id="confirmPasswordError"></div>
                </div>
    ...
    <script id="form-interactions">
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Debug: Check if error elements exist
            ...
            function validatePassword(passwordValue) {
                ...
                return { hasMinLength, hasSpecialChar, hasNumber, isValid: hasMinLength && hasSpecialChar && hasNumber };
            }
            ...
            signUpForm.addEventListener('submit', function (e) {
                ...
                if (!password.value) {
                    ...
                    if (!validation.isValid) {
                        showError('password', 'Password must be at least 6 characters with a number and special character');
                        isValid = false;
                    }
                }
