    ...
    <nav class="fixed top-0 left-0 right-0 z-50 nav-sticky">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="{{ route('user.solutions') }}"
                        class="text-gray-300 hover:text-primary transition-colors">Solutions</a>
                    <a href="{{ route('user.about') }}"
                        class="text-gray-300 hover:text-primary transition-colors">About</a>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative">
                        <a href="{{ route('user.cart') }}" class="w-8 h-8 flex items-center justify-center">
                            <i
                    ...
                    <div class="hidden md:relative md:inline-block">
                        <button id="account-menu-button"
                            class="flex items-center justify-center w-9 h-9 text-gray-400 hover:text-primary transition-colors"
                            title="Account" aria-label="Account" aria-expanded="false">
                        ...
                        <div id="account-dropdown"
                            ...
                            <a href="#"
                                ...
                                class="flex items-center gap-2 px-4 py-2 text-gray-300 hover:text-primary hover:bg-gray-700 rounded-md transition-colors">
        ...
        <div id="mobile-menu"
            ...
            <div class="px-4 py-3 space-y-2">
                ...
                <a href="{{ route('user.orders') }}"
                    class="block text-gray-300 hover:text-primary px-3 py-2 rounded-md">My Orders</a>
                <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                    class="flex items-center gap-2 text-gray-300 hover:text-primary px-3 py-2 rounded-md"><i
                        class="ri-login-box-line"></i><span>Logout</span></a>
            </div>
        </div>
...
<script>
    ...
    if (accountMenuButton) {
        accountMenuButton.addEventListener('click', function (e) {
            ...
            this.setAttribute('aria-expanded', accountDropdown.classList.contains('hidden') ? 'false' : 'true');
        });
