...
<body class="bg-black text-white font-sans overflow-x-hidden">
    ...
    <section class="py-20 bg-black" data-aos="fade-right">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-8">
                <div
                    class="border border-primary rounded-xl p-8 flex flex-col lg:flex-row items-center gap-8 card-hover">
                    <div class="lg:w-1/3">
                ...
                <div
                    class="border border-primary rounded-xl p-8 flex flex-col lg:flex-row-reverse items-center gap-8 card-hover">
                    <div class="lg:w-1/3">
